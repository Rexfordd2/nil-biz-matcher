...
export default function AthleteHouzeHandoffBanner() {
	...
	return (
		<div
			className="border-b border-slate-200 bg-slate-100 px-4 py-2 text-xs text-slate-700"
		...
		>
			<div className="mx-auto max-w-6xl flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
				<div className="min-w-0">
					<span className="font-semibold text-slate-900" data-testid="athlete-houze-handoff-label">
				...
				<a
					...
					rel="noopener"
					className="shrink-0 underline font-semibold text-slate-900"
