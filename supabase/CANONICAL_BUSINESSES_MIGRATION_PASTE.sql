-- ============================================================================
-- Canonical businesses migration — paste this entire block into Supabase SQL Editor
-- ============================================================================
-- Where: Supabase Dashboard → your project → SQL Editor → New query → paste → Run
-- CLI alternative: supabase login → supabase link --project-ref <ref> → supabase db push
-- ============================================================================

-- Canonical businesses table (place_id unique) + user_businesses overlay (user_id + place_id)
...
-- Authenticated users can read any canonical row (for listUserBusinesses join)
...
-- Authenticated users can insert/update canonical rows (upsert from Discover or form)
